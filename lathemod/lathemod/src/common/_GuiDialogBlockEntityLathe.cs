...
namespace lathemod.src.common {
    public class _GuiDialogBlockEntityLathe : GuiDialogBlockEntity {
        long lastRedrawMs;
        protected override double FloatyDialogPosition => 0.75;

        public _GuiDialogBlockEntityLathe(string dialogTitle, BlockPos blockEntityPos, ICoreClientAPI capi) : base(dialogTitle, blockEntityPos, capi) {
        }

        public _GuiDialogBlockEntityLathe(string dialogTitle, InventoryBase inventory, BlockPos blockEntityPos, ICoreClientAPI capi) : base(dialogTitle, inventory, blockEntityPos, capi) {
        ...
        private void OnInventorySlotModified(int slotid) {
            capi.Event.EnqueueMainThreadTask(SetupDialog, "setuplathedlg");
        }
        ...
        float inputTurnTime, maxTurnTime;
        ...
        private void OnBgDraw(Context ctx, ImageSurface surface, ElementBounds currentBounds) {
            ...
            double dx = inputTurnTime / maxTurnTime;
